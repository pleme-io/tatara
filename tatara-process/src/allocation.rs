...
// RequestorKind` are generated by `#[derive(tatara_lisp::DeriveClosedSet)]`
...
// consumers reach the STABLE workspace-wide name (`label`).
...
// AllocationPhase` are generated by `#[derive(tatara_lisp::DeriveClosedSet)]`
// on the enum declaration above. `label` delegates to the inherent
