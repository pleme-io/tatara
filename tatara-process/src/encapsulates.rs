...
// `tatara_closed_set::assert_closed_set_well_formed::<EncapsulationTarget>()` (called
...
// verbatim — pinned generically by clause (5) of
// `tatara_closed_set::assert_closed_set_well_formed::<EncapsulationMode>()` (called
...
mod tests {
    ...
    fn mode_is_well_formed_closed_set() {
        tatara_closed_set::assert_closed_set_well_formed::<EncapsulationMode>();
    }
    ...
    /// delegates to `<Self as tatara_closed_set::ClosedSet>::parse_label`, so
    ...
    fn encapsulation_target_is_well_formed_closed_set() {
        tatara_closed_set::assert_closed_set_well_formed::<EncapsulationTarget>();
    }
