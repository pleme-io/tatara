...
// ReportFormat` are generated by `#[derive(tatara_closed_set::DeriveClosedSet)]`
...
// ChannelKind` are generated by `#[derive(tatara_closed_set::DeriveClosedSet)]`
...
// ExportTrigger` are generated by `#[derive(tatara_closed_set::DeriveClosedSet)]`
// on the enum declaration above.
...
mod tests {
    ...
    fn export_trigger_is_well_formed_closed_set() {
        tatara_closed_set::assert_closed_set_well_formed::<ExportTrigger>();
    }
    ...
    fn report_format_is_well_formed_closed_set() {
        tatara_closed_set::assert_closed_set_well_formed::<ReportFormat>();
    }
    ...
    fn artifact_kind_is_well_formed_closed_set() {
        tatara_closed_set::assert_closed_set_well_formed::<ArtifactKind>();
    }
    ...
    fn channel_kind_is_well_formed_closed_set() {
        tatara_closed_set::assert_closed_set_well_formed::<ChannelKind>();
    }
